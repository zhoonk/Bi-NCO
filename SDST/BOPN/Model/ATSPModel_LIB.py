...
class MixedScore_MultiHeadAttention(nn.Module):
    def __init__(self, **model_params):
        ...
        # self.theta1 = nn.Parameter(torch.empty(head_num, qkv_dim, qkv_dim))
        # self.theta2 = nn.Parameter(torch.empty(head_num, qkv_dim, qkv_dim))

        # self.bias_q = nn.Parameter(torch.empty(head_num, qkv_dim))
        # self.bias_k = nn.Parameter(torch.empty(head_num, qkv_dim))
        # self.bias_theta = nn.Parameter(torch.empty(head_num, qkv_dim))
